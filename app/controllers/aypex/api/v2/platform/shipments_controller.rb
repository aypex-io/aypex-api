      ...
      module Platform
        class ShipmentsController < ResourceController
          ...
          def transfer_to_location
            stock_location = Aypex::StockLocation.find(params.dig(:shipment, :stock_location_id))
          ...
          def transfer_to_shipment
            target_shipment = Aypex::Shipment.find_by!(number: params.dig(:shipment, :target_shipment_number))
            quantity = params.dig(:shipment, :quantity)&.to_i || 1
          ...
          def aypex_permitted_attributes
            Aypex::Shipment.json_api_permitted_attributes + [
