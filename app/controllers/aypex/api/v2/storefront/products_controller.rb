module Aypex
  module Api
    module V2
      module Storefront
        class ProductsController < ::Aypex::Api::V2::ResourceController
          ...
          def collection_sorter
            Aypex::Api::Dependencies.storefront_products_sorter.constantize
          end

          def collection_finder
            Aypex::Api::Dependencies.storefront_products_finder.constantize
          end

          def collection_serializer
            Aypex::Api::Dependencies.storefront_product_serializer.constantize
          end
          ...
          def filters_meta
            Aypex::Api::Products::FiltersPresenter.new(current_store, current_currency, params).to_h
          end
        end
      end
    end
