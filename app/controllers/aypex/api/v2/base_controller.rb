  ...
  module Api
    module V2
      class BaseController < ActionController::API
        ...
        def content_type
          Aypex::Api::Config.api_v2_content_type
        end
        ...
        alias_method :try_aypex_current_user, :aypex_current_user

        def aypex_authorize!(action, subject, *args)
          authorize!(action, subject, *args)
        end

        def require_aypex_current_user
          raise CanCan::AccessDenied if aypex_current_user.nil?
        end
        ...
        def serializer_params
          {
            ...
            images_transformed_to: params[:images_transformed_to]
          }
        end
        ...
        def error_during_processing(exception)
          result = error_handler.call(exception: exception, opts: {user: aypex_current_user})
