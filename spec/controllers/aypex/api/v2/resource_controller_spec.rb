...
class ApiV2DummyController < Aypex::Api::V2::ResourceController
  private
...
describe Aypex::Api::V2::ResourceController, type: :controller do
  ...
  describe "#collection" do
    ...
    before do
      ...
      allow(dummy_controller).to receive(:current_store).and_return(store)
      allow(dummy_controller).to receive(:aypex_current_user).and_return(nil)
    end

    it { expect(collection.first).to be_instance_of(Aypex::Product) }
