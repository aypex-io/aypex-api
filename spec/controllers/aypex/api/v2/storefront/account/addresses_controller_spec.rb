  ...
  describe "addresses#create" do
    ...
    context "valid request" do
      ...
      it "creates address" do
        expect { post_create }.to change { Aypex::Address.count }.by(1)
      end
    end
    ...
    context "invalid request" do
      ...
      it "does not create address" do
        expect { post_create }.to change { Aypex::Address.count }.by(0)
      end
    end
  ...
  describe "addresses#update" do
    ...
    context "when address is editable" do
      context "valid request" do
        ...
        it "does not create new address" do
          expect { patch_update }.to change { Aypex::Address.count }.by(0)
        end
      end
    ...
    context "when address is not editable" do
      ...
      context "valid request" do
        ...
        it "creates address" do
          expect { patch_update }.to change { Aypex::Address.count }.by(1)
        end
