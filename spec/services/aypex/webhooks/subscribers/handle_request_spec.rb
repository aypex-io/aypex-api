...
describe Aypex::Webhooks::Subscribers::HandleRequest do
  describe '#call' do
    ...
    let(:webhook_payload_body) do
      Aypex::Api::V2::Platform::AddressSerializer.new(
        resource,
    ...
    shared_examples 'logging and creating a webhooks event' do |with_log_level:|
      ...
      context 'before making the request' do
        ...
        it 'debug logs' do
          ...
          subject.call
          message_fst = "[AYPEX WEBHOOKS] 'order.canceled' sending to 'http://google.com/'"
          message_snd = "[AYPEX WEBHOOKS] 'order.canceled' webhook_payload_body: #{body_with_event_metadata}"
