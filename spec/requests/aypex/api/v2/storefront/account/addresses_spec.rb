...
describe "Storefront API v2 Addresses spec" do
  ...
  describe "addresses#index" do
    context "without options" do
      ...
      it "returns all user addresses" do
        ...
        expect(json_response["data"].size).not_to eq Aypex::Address.count
      end
    end
  ...
  describe "addresses#destroy" do
    ...
    context "valid request" do
      ...
      it "destroys address permanently" do
        expect { Aypex::Address.unscoped.find(address.id) }.to raise_exception(ActiveRecord::RecordNotFound)
