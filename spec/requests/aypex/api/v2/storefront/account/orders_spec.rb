...
describe "Storefront API v2 Orders spec" do
  ...
  describe "orders#index" do
    context "with option: include" do
      ...
      it "returns included resource" do
        expect(json_response["included"].size).to eq Aypex::Order.count
    ...
    context "when per_page is between 1 and default value" do
      ...
      context "with specified pagination params" do
        ...
        it "returns proper meta data" do
          ...
          expect(json_response["meta"]["total_count"]).to eq Aypex::Order.count
        end
    ...
    context "without specified pagination params" do
      ...
      it "returns specified amount orders" do
        expect(json_response["data"].count).to eq Aypex::Order.count
      end

      it "returns proper meta data" do
        expect(json_response["meta"]["count"]).to eq Aypex::Order.count
        expect(json_response["meta"]["total_count"]).to eq Aypex::Order.count
      end
