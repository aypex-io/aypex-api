...
describe "Storefront API v2 Countries spec" do
  ...
  describe "country#show" do
    ...
    context "when different current store" do
      ...
      before do
        allow_any_instance_of(Aypex::Api::V2::Storefront::CountriesController).to receive(:current_store).and_return(second_store)
        get "/api/v2/storefront/countries/default"
      end
