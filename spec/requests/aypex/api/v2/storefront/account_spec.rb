...
describe "Storefront API v2 Account spec" do
  ...
  describe "users#create" do
    ...
    context "invalid request" do
      ...
      before do
        allow(Aypex::Api::Dependency).to receive_message_chain(:storefront_account_create_service, :constantize).and_return(service)
      end
  ...
  describe "users#update" do
    ...
    context "invalid request" do
      ...
      context "password mismatch error" do
        ...
        before do
          allow(Aypex::Api::Dependency).to receive_message_chain(:storefront_account_update_service, :constantize).and_return(service)
        end
        ...
        describe "mocks" do
          ...
          it { expect(Aypex::Api::Dependency).to receive_message_chain(:storefront_account_update_service, :constantize).and_return(service) }
