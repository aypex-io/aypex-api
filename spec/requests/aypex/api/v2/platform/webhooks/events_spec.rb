...
describe "Platform API v2 Webhooks Events spec" do
  ...
  describe "#index" do
    context "filtering" do
      ...
      context "by request_errors" do
        let!(:event_1) { create(:event, :failed, request_errors: "[AYPEX WEBHOOKS] 'order.canceled' can not make a request to 'http://google.com/'") }
      ...
      context "by url" do
        let!(:event_1) { create(:event, url: "https://mysite.com/aypex_webhooks") }
