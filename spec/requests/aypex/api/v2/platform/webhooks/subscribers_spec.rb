...
describe "Platform API v2 Webhooks Subscribers spec" do
  include_context "API v2 tokens"
  include_context "Platform API v2"

  let(:bearer_token) { {"Authorization" => valid_authorization} }
  let(:type) { "subscriber" }
  let(:url) { "https://www.mysite.com/aypex_webhooks" }
  ...
  describe "#index" do
    context "filtering" do
      ...
      context "by active" do
        ...
        context "active" do
          let(:active) { true }
          let(:active_subscribers) { Aypex::Webhooks::Subscriber.active }
        ...
        context "inactive" do
          let(:active) { false }
          let(:inactive_subscribers) { Aypex::Webhooks::Subscriber.inactive }
      ...
      context "by url" do
        ...
        before { get "/api/v2/platform/webhooks/subscribers?filter[url_cont]=aypex_webhooks", headers: bearer_token }
