    ...
    expect(subject).to eq(
      {
        data: {
          ...
          attributes: {
            ...
            mailer_logo: url_helpers.rails_blob_path(resource.mailer_logo.mailer_attachment),
            favicon_path: url_helpers.rails_blob_path(resource.favicon_image.favicon_attachment),
