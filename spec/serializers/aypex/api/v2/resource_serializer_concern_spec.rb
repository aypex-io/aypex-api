...
module Aypex
  ...
  module Api
    module V2
      module Platform
        class TestOrderSerializer < ::Aypex::Api::V2::BaseSerializer
          include Aypex::Api::V2::ResourceSerializerConcern
        end
      end
    end
  end
...
describe Aypex::Api::V2::ResourceSerializerConcern do
  describe ".included" do
    ...
    let(:serializable_hash) { Aypex::Api::V2::Platform::TestOrderSerializer.new(test_order).serializable_hash }
    let(:test_order) do
      Aypex::TestOrder.new(
