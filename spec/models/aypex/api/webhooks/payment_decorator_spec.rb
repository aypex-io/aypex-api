...
describe Aypex::Api::Webhooks::PaymentDecorator do
  let(:webhook_payload_body) do
    Aypex::Api::V2::Platform::PaymentSerializer.new(
      payment,
      include: Aypex::Api::V2::Platform::PaymentSerializer.relationships_to_serialize.keys - [:state_changes]
      ).serializable_hash
  end
  ...
  before do
    ...
    allow(payment).to receive(:included_relationships).and_return(Aypex::Api::V2::Platform::PaymentSerializer.relationships_to_serialize.keys - [:state_changes])
  end
  ...
  describe 'order.paid' do
    ...
    let(:webhook_payload_body) do
      Aypex::Api::V2::Platform::OrderSerializer.new(
        order,
        include: Aypex::Api::V2::Platform::OrderSerializer.relationships_to_serialize.keys
      ).serializable_hash
    end
